	...
	public struct Options: OptionsProtocol {
		...
		public static func evaluate(_ mode: CommandMode, dependenciesUsage: String) -> Result<Options, CommandantError<CarthageError>> {
			return curry(self.init)
				<*> mode <| Option(key: "use-ssh", defaultValue: CCon.isUsingSSH, usage: "use SSH for downloading GitHub repositories")
				<*> mode <| Option(key: "use-submodules", defaultValue: CCon.isUsingSubmodules, usage: "add dependencies as Git submodules")
