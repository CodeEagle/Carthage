...
public struct UpdateCommand: CommandProtocol {
	public struct Options: OptionsProtocol {
		...
		public static func evaluate(_ mode: CommandMode) -> Result<Options, CommandantError<CarthageError>> {
			...
			let newResolverUSage = "use the new resolver codeline when calculating dependencies. Default is false"
			...
			return curry(self.init)
				...
				<*> mode <| Option(key: "new-resolver", defaultValue: isEnableNewResolver, usage: newResolverUSage)
